<?php
    ...
    $nav_Aviso = true;
    $nav_AvisoPersonalizado = '<b>ATENÇÃO: </b>Preencha o formulário abaixo e entre na lista de espera para garantir o seu <b>Focus Alfa!</b>';
    $nav_StepsCheckout = false;

    /* Variações necessárias na página -------------------- */
    $nav_Home['url'] = '#formulario';
    $nav_Home['label'] = 'Lista de Espera';
